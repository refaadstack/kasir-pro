...
export default function SupervisorDashboard() {
  ...
  return (
    <div className="p-4 space-y-4">
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-xl font-black text-white">Dashboard Supervisor 👋</h1>
      ...
      <Card className="bg-white/[0.04] border-white/10">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-2">
            <Link href="/dashboard/supervisor/transaksi">
              <button className="w-full p-3 bg-white/5 hover:bg-amber-400/10 border border-white/10 hover:border-amber-400/30 rounded-xl transition-all text-left">
                ...
                <div className="text-xs font-semibold text-white">Kelola Transaksi</div>
                <div className="text-[10px] text-white/40">Void & monitoring</div>
              </button>
            </Link>
            <Link href="/dashboard/supervisor/laporan">
            ...
            <Link href="/dashboard/supervisor/shift">
              <button className="w-full p-3 bg-white/5 hover:bg-green-400/10 border border-white/10 hover:border-green-400/30 rounded-xl transition-all text-left">
                ...
                <div className="text-xs font-semibold text-white">Monitor Shift</div>
                <div className="text-[10px] text-white/40">Shift karyawan</div>
              </button>
            </Link>
            <Link href="/dashboard/kasir">
              <button className="w-full p-3 bg-white/5 hover:bg-purple-400/10 border border-white/10 hover:border-purple-400/30 rounded-xl transition-all text-left">
                ...
                <div className="text-xs font-semibold text-white">POS</div>
                <div className="text-[10px] text-white/40">Point of Sale</div>
              </button>
            </Link>
          </div>
        </CardContent>
