...
import { Search, Receipt, Eye, Ban } from 'lucide-react'
import { Card, CardContent } from '@/components/ui/card'
import { Input } from '@/components/ui/input'
import { EmptyState } from '@/components/ui/EmptyState'
import { LoadingSpinner } from '@/components/ui/LoadingSpinner'
import { ThermalReceipt } from '@/components/superadmin/ThermalReceipt'
import { VoidModal } from '@/components/supervisor/VoidModal'
...
export default function TransaksiPage() {
  ...
  return (
    <div className="p-4 space-y-4">
      {/* Header */}
      <div>
        <h1 className="text-xl font-black text-white">Kelola Transaksi</h1>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    {transaction.status === 'COMPLETED' && (
                      <button
                        onClick={() => setVoidTransaction(transaction)}
      ...
      {voidTransaction && (
        <VoidModal
          ...
          transactionCode={voidTransaction.code}
