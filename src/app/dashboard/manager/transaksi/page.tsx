          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                statusFilter === null ? 'bg-amber-400 text-gray-900' : 'bg-white/5 text-white/60 hover:bg-white/10'
              }`}
            >
              Semua
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                statusFilter === 'SUCCESS' ? 'bg-amber-400 text-gray-900' : 'bg-white/5 text-white/60 hover:bg-white/10'
              }`}
            >
              Selesai
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                statusFilter === 'VOID' ? 'bg-amber-400 text-gray-900' : 'bg-white/5 text-white/60 hover:bg-white/10'
              }`}
            >
              Dibatalkan
            </button>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-white/60">{transaction.payment_method} • {formatDate(transaction.created_at)}</p>
                  </div>
