...
const navItems = [
  ...
  { label: 'Transaksi', href: '/dashboard/supervisor/transaksi', icon: Receipt },
  { label: 'Laporan', href: '/dashboard/supervisor/laporan', icon: FileText },
  { label: 'Shift', href: '/dashboard/supervisor/shift', icon: Clock },
  { label: 'Lainnya', href: '/dashboard/supervisor/more', icon: Settings },
]
